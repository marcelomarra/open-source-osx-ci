...
echo "*        PACKAGIN          *"
echo "***************************"
./scripts/xcbuild-safe.sh -project $APP_NAME.xcodeproj -scheme $APP_NAME -sdk iphoneos -configuration Release archive -archivePath $PWD/build/open-source-osx-ci.xcarchive
echo "***************************"
echo "*        SIGNING          *"
echo "***************************"
